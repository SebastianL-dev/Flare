...
export default function SimpleFooter() {
  return (
    <footer className="bottom-0 md:absolute w-full bg-opacity-5 gap-16 grid bg-purple-400 border-t-2 border-purple-500 border-opacity-20 h-min self-end">
      <section className="flex justify-between mx-[20%] max-[1400px]:mx-[10%] max-[1150px]:mx-[5%] max-lg:mx-[20%] max-md:mx-[5%] items-center text-neutral-300 py-3">
        ...
        <ul className="flex gap-4" aria-label="Social media links">
          <SocialMediaBtn
            ...
            icon={
              <FaInstagram className="w-7 h-7 text-white text-opacity-35 hover:scale-[1.15] hover:text-opacity-80 duration-200 transition-all ease-linear cursor-pointer" />
            }
            social="Instagram"
          />
          <SocialMediaBtn
            ...
            icon={
              <FaGithub className="w-7 h-7 text-white text-opacity-35 hover:scale-[1.15] hover:text-opacity-80 duration-200 transition-all ease-linear cursor-pointer" />
            }
            social="GitHub"
          />
        </ul>
