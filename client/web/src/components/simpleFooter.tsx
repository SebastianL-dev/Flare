...
import FooterButtonsSection from "./common/footer/footerButtonsSection";
...
export default function SimpleFooter() {
  return (
    <footer className="mt-auto bg-opacity-5 gap-16 grid bg-purple-400">
      <section className="mx-[20%] max-[1400px]:mx-[10%] pt-12 max-[1150px]:mx-[5%] max-lg:mx-[20%] max-md:mx-[5%] max-lg:flex-col max-lg:gap-12 flex items-start justify-between relative">
