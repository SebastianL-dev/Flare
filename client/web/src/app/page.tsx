        ...
        <div className="max-w-[50%] flex flex-col gap-16 max-lg:max-w-full">
          <div className="flex flex-col gap-4 max-lg:items-center">
            ...
            <p className="w-full text-neutral-400 max-lg:text-center">
              ...
              <strong className="text-white text-opacity-75">The Rooms</strong>{" "}
              and start your new{" "}
              <strong className="text-white text-opacity-75">adventure</strong>.
          ...
          <HomeCard
            ...
            text={
              <p className="text-base text-white text-opacity-50">
                ...
                <strong className="text-white text-opacity-75">room ID</strong>{" "}
            ...
            text={
              <>
                <p className="text-base text-white text-opacity-60">
                  In rooms, your chat history isn&apos;t saved, but by creating
                  an{" "}
                  <strong className="text-white text-opacity-75">
                    account
                  </strong>
                  , you can save your conversations and send direct messages to
                  your friends. Don&apos;t wait anymore, create an account and{" "}
                  <strong className="text-white text-opacity-75">
                    start chatting now
                  </strong>
                  !
          ...
          <HomeCard
            ...
            text={
              <p className="text-base text-white text-opacity-60">
                ...
                and{" "}
                <strong className="text-white text-opacity-75">desktop</strong>{" "}
